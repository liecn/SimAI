...
case "$1" in
  ...
  ns3)
    ...
    time AS_SEND_LAT=3 AS_NVLS_ENABLE=1 AS_FWIN=50 ./bin/SimAI_simulator -t 8 -w ./example/sweep/microAllReduce.txt -n ./example/sweep/$TOPOFILE -c ./example/sweep/SimAI.conf -o ./results/ns3_${N}_${M}/ -r
    ;;
  m4)
