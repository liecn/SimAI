...
case "$1" in
  flowsim)
    time AS_SEND_LAT=3 AS_NVLS_ENABLE=1 AS_FWIN=$((400 / M)) ./bin/SimAI_flowsim -w ./example/sweep/microAllReduce.txt -n ./example/sweep/$TOPOFILE -o ./results/flowsim_${N}_${M}/
    ;;
  ns3)
    ...
    ;;
  m4)
    time AS_SEND_LAT=3 AS_NVLS_ENABLE=1 AS_FWIN=$((400 / M)) ./bin/SimAI_m4 -w ./example/sweep/microAllReduce.txt -n ./example/sweep/$TOPOFILE -o ./results/m4_${N}_${M}/
    ;;
