...
case "$1" in
  flowsim)
    time AS_SEND_LAT=3 AS_NVLS_ENABLE=1 AS_FWIN=200 ./bin/SimAI_flowsim -w ./example/sweep/microAllReduce.txt -n ./example/sweep/$TOPOFILE -o ./results/flowsim_${N}_${M}/
    ;;
  ns3)
